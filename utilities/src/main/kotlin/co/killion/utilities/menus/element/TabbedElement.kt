...
import co.killion.utilities.menus.InventorySection
...
class TabbedElement(
    ...
    var dividers: Array<out ItemStack>? = arrayOf(ItemStack(Material.RED_STAINED_GLASS))
    var selectedDivider: ItemStack? = ItemStack(Material.GREEN_STAINED_GLASS)
    ...
    companion object : Type<TabbedElement> {
